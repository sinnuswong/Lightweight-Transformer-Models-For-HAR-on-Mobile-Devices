...
print("模型已加载")
input = np.random.uniform(0.0, 1.0, size=[32, 10, 5]).astype(np.float32)  # Lenet模型的size为32,1,32,32
export(loaded_model, Tensor(input), file_name='lstm', file_format='MINDIR')  # file_name指定转换后文件的文件名

# 代码是2.3.0写的，转模型的工具convert是2.4.0