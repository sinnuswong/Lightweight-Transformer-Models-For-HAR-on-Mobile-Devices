...
epochs = 46  # (128,20: 20, 8) (32,20: 15, 16)
...
model.add(tf.keras.layers.GRU(hidden_size, return_sequences=False, input_shape=(window_size, feature_size), dropout=0.2))
