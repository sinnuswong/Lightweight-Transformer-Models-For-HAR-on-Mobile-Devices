...
def test_with_padding(motion_frame, feature_size, window_size, padding=10):
    ...
    for i in range(10, len(motion_frame - padding - window_size), window_size):
        ...
        prev_res = cur_hit_recognizer.predict(prev_window_frame, window_size=window_size, feature_size=feature_size)
        next_res = cur_hit_recognizer.predict(next_window_frame, window_size=window_size, feature_size=feature_size)
        flag = -1
        max_res = 0
